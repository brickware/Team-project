...
public class RecordClient
{
   ...
   public static void testUpdateElo()
   {
      ...
      Rankable rte = new RecordWithTiesAndElo();
      RecordWithTiesAndElo rte2 = new RecordWithTiesAndElo(); 
      int x = rte.isBetterThan(rte2); 
           
      RecordWithTiesAndElo r1 = new RecordWithTiesAndElo(); 
      r1.setEloRating(1400); 
      RecordWithTiesAndElo r2 = new RecordWithTiesAndElo(); 
      r2.setEloRating(1800); 
      ...
      r1.setEloRating(1400); 
      r2.setEloRating(1800); 
      RecordWithTiesAndElo.updateElo(r1, r2, .5); 
      System.out.println(r1); 
      System.out.println(r2);  
   }      
   ...
   public static void testEquals()
   {
      ...
      RecordWithTies rwt = new RecordWithTies(); 
      rwt.setWins(10); 
      rwt.setLosses(20);     
   
      System.out.println("rwt.equals(r) is " + rwt.equals(r)); 
      System.out.println("r.equals(rwt) is " + r.equals(rwt)); 
    }
